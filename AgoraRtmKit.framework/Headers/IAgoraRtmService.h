...
/**
 The prefix for ending a call. You can use it with the \ref
 agora::rtm::IRtmService::sendMessageToPeer(const char *peerId, const IMessage *message, const
 SendMessageOptions &options) "sendMessageToPeer" method to be compatible with the endCall method of
 the legacy Agora Signaling SDK.
 */
...
enum LOGIN_ERR_CODE {
  ...
  /**
   8: The user has already logged in or is logging in the Agora RTM system, or the user has not
   called the \ref agora::rtm::IRtmService::logout "logout" method to leave the \ref
   agora::rtm::CONNECTION_STATE_ABORTED "CONNECTION_STATE_ABORTED" state.
   */
  ...
  /**
   10: The call frequency of the \ref agora::rtm::IRtmService::login "login" method exceeds the
   limit of two queries per second.
   */
...
enum LOGOUT_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before the user logs out of
...
enum RENEW_TOKEN_ERR_CODE {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before renewing the token.
   */
...
enum CONNECTION_STATE {
  ...
  /**
   ...
   When the user calls the \ref agora::rtm::IRtmService::login "login" method, the SDK starts to log
   in the Agora RTM system, triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged"
   callback, and switches to the \ref agora::rtm::CONNECTION_STATE_CONNECTING
  ...
  /**
   ...
   - If the user successfully logs in the Agora RTM system and receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess" callback, the SDK triggers
   the \ref agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged"
   callback and switches to the \ref agora::rtm::CONNECTION_STATE_CONNECTED
   "CONNECTION_STATE_CONNECTED" state.
   - If the user fails to login the Agora RTM system and receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback, the SDK triggers
   the \ref agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged"
   callback and switches to the \ref agora::rtm::CONNECTION_STATE_DISCONNECTED
  ...
  /**
   ...
   - If the connection state between the SDK and the Agora RTM system is interrupted because of
   network issues, the SDK triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback
   and switches to the \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   - If the login is banned by the server because, for example, another instance logs in the Agora
   RTM system with the same user ID, the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback
   is triggered, and the SDK is switched to the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" state.
   - If the user calls the \ref agora::rtm::IRtmService::logout "logout" method to log out of the
   Agora RTM system and receives the \ref agora::rtm::IRtmServiceEventHandler::onLogout "onLogout"
   callback (error code = `LOGOUT_ERR_OK`), the SDK triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback
   and switches to the \ref agora::rtm::CONNECTION_STATE_DISCONNECTED
   "CONNECTION_STATE_DISCONNECTED" state.
   */
  CONNECTION_STATE_CONNECTED = 3,

  /**
   4: The connection state between the SDK and the Agora RTM system is interrupted due to network
   issues, and the SDK keeps re-logging in the Agora RTM system.

   - If the SDK successfully re-logs in the Agora RTM system, the SDK triggers the \ref
   agora::rtm::IRtmServiceEventHandler::onConnectionStateChanged "onConnectionStateChanged" callback
   and switches to the \ref agora::rtm::CONNECTION_STATE_CONNECTED "CONNECTION_STATE_CONNECTED"
   state. The SDK automatically adds the user back to the channels he or she was in when the
   connection was interrupted, and synchronizes the local user's attributes with the server.
   - If the SDK cannot re-log in the Agora RTM system, it stays in the \ref
   agora::rtm::CONNECTION_STATE_RECONNECTING "CONNECTION_STATE_RECONNECTING" state and keeps
   re-logging in the system.
   */
  CONNECTION_STATE_RECONNECTING = 4,

  /**
   5: The SDK gives up logging in the Agora RTM system, mainly because another instance has logged
   in the Agora RTM system with the same user ID.

   You must call the \ref agora::rtm::IRtmService::logout "logout" method to leave this state before
   calling the \ref agora::rtm::IRtmService::login "login" method again.
   */
...
enum CONNECTION_CHANGE_REASON {
  ...
  /**
   5: The connection between the SDK and the Agora RTM system is interrupted. The system defines an
   interruption when the SDK loses connection with the Agora RTM system for network reasons and
   cannot recover in four seconds.
   */
  CONNECTION_CHANGE_REASON_INTERRUPTED = 5,

  /**
   6: The user has called the \ref agora::rtm::IRtmService::logout "logout" method to log out of the
   Agora RTM system.
   */
...
enum PEER_MESSAGE_ERR_CODE {
  ...
  /**
   2: A timeout occurs when sending the peer-to-peer message. The current timeout is set as 10
   seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   4: The receiver is offline and does not receive this offline peer-to-peer message, but the server
   has cached it and will re-send it once he/she is back online.
   */
  PEER_MESSAGE_ERR_CACHED_BY_SERVER = 4,

  /**
   5: The method call frequency exceeds the limit of (RTM SDK for Windows C++) 180 calls every three
   seconds or (RTM SDK for Linux C++) 1500 calls every three seconds, with channel and peer messages
   taken together..
   */
  ...
  /**
   102: The sender does not call the \ref agora::rtm::IRtmService::login "login" method, or the
   method call of \ref agora::rtm::IRtmService::login "login" does not succeed before sending the
...
enum JOIN_CHANNEL_ERR {
  ...
  /**
   2: For v1.0.0 and earlier, the SDK returns this error when you try to join a channel that you
   have already joined. The SDK does not return this error code after v1.0.0.
   */
  ...
  /**
   ...
   Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before joining the channel.
   */
...
enum LEAVE_CHANNEL_ERR {
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before calling the \ref
   agora::rtm::IChannel::leave "leave" method.
   */
...
enum CHANNEL_MESSAGE_ERR_CODE {
  ...
  /**
   2: The SDK does not receive a response from the server in 10 seconds. The current timeout is set
   as 10 seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   3: The method call frequency exceeds the limit of (RTM SDK for Windows C++) 180 calls every three
   seconds or (RTM SDK for Linux C++) 1500 calls every three seconds, with channel and peer messages
   taken together..
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before sending out a channel
   message.
   */
...
enum GET_MEMBERS_ERR {
  ...
  /**
   3: A timeout occurs when retrieving a member list of the channel. The current timeout is set as
   five seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before retrieving a member
   list.
   */
...
enum QUERY_PEERS_ONLINE_STATUS_ERR {
  ...
  /**
   4: The SDK fails to receive a response from the server in 10 seconds. The current timeout is set
   as 10 seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   5: The method call frequency exceeds the limit of (RTM SDK for Windows C++) 10 calls every five
   seconds or (RTM SDK for Linux C++) 100 calls every five seconds.
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before querying the online
   status.
   */
...
enum PEER_ONLINE_STATE {
  ...
  /**
   1: The peer is temporarily unreachable (the server has not received a packet from the SDK for
   more than six seconds).
   */
  PEER_ONLINE_STATE_UNREACHABLE = 1,

  /**
   2: The peer is offline (the SDK has not logged in the Agora RTM system, or it has logged out of
   the system, or the server has not received a packet from the SDK for more than 30 seconds).
   */
...
enum PEER_SUBSCRIPTION_STATUS_ERR {
  ...
  /**
   4: The SDK fails to receive a response from the server within 10 seconds. The current timeout is
   set as 10 seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before this operation.
   */
...
enum QUERY_PEERS_BY_SUBSCRIPTION_OPTION_ERR {
  ...
  /**
   2: The SDK fails to receive a response from the server within 5 seconds. The current timeout is
   set as 5 seconds. Possible reasons: The user is in the \ref agora::rtm::CONNECTION_STATE_ABORTED
   "CONNECTION_STATE_ABORTED" or \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before the query.
   */
...
enum ATTRIBUTE_OPERATION_ERR {
  ...
  /**
   3: The argument you put for this attribute operation is invalid. For example, you cannot set a
   user or channel attribute as "".
   */
  ...
  /**
   ...
   - For user attribute operations: The user's overall attribute size would exceed the limit of 16
   KB, one of the user's attributes would exceeds 8 KB in size, or the number of this user's
   attributes would exceed 32 after this attribute operation.
   - For channel attribute operations: The channel's overall attribute size would exceed the limit
   of 32 KB, one of the channel attributes would exceed 8 KB in size, or the number of this
   channel's attributes would exceed 32 after this attribute operation.
   */
  ...
  /**
   ...
   - For \ref agora::rtm::IRtmService::setLocalUserAttributes "setLocalUserAttributes", \ref
   agora::rtm::IRtmService::addOrUpdateLocalUserAttributes "addOrUpdateLocalUserAttributes", \ref
   agora::rtm::IRtmService::deleteLocalUserAttributesByKeys "deleteLocalUserAttributesByKeys" and
   \ref agora::rtm::IRtmService::clearLocalUserAttributes "clearLocalUserAttributes" taken together:
   the maximum call frequency is (RTM SDK for Windows C++) 10 calls every five seconds or (RTM SDK
   for Linux C++) 100 calls every five seconds.
   - For \ref agora::rtm::IRtmService::getUserAttributes "getUserAttributes" and \ref
   agora::rtm::IRtmService::getUserAttributesByKeys "getUserAttributesByKeys" taken together, the
   maximum call frequency is (RTM SDK for Windows C++) 40 calls every five seconds or (RTM SDK for
   Linux C++) 400 calls every five seconds.
   - For \ref agora::rtm::IRtmService::setChannelAttributes "setChannelAttributes", \ref
   agora::rtm::IRtmService::addOrUpdateChannelAttributes "addOrUpdateChannelAttributes", \ref
   agora::rtm::IRtmService::deleteChannelAttributesByKeys "deleteChannelAttributesByKeys" and \ref
   agora::rtm::IRtmService::clearChannelAttributes "clearChannelAttributes" taken together: the
   maximum call frequency is (RTM SDK for Windows C++) 10 calls every five seconds or (RTM SDK for
   Linux C++) 100 calls every five seconds.
   - For \ref agora::rtm::IRtmService::getChannelAttributes "getChannelAttributes" and \ref
   agora::rtm::IRtmService::getChannelAttributesByKeys "getChannelAttributesByKeys" taken together,
   the maximum call frequency is (RTM SDK for Windows C++) 10 calls every five seconds or (RTM SDK
   for Linux C++) 400 calls every five seconds.
   */
  ATTRIBUTE_OPERATION_ERR_TOO_OFTEN = 5,

  /**
   6: The specified user is not found, either because the user is offline or because the user does
   not exist.
   */
  ...
  /**
   102: The user does not call the \ref agora::rtm::IRtmService::login "login" method, or the method
   call of \ref agora::rtm::IRtmService::login "login" does not succeed before the attribute
   operation.
   */
...
enum DOWNLOAD_MEDIA_ERR_CODE {
  ...
  /**
   4: The file or image to download does not exist, either because the media ID you input is
   incorrect or because the validity of the media ID has expired.
   */
...
enum UPLOAD_MEDIA_ERR_CODE {
  ...
  /**
   1: Unknown common failure. Please check whether the file exists and whether you can access the
   file.
   */
  ...
  /**
   5: You have exceeded the upper limit for file upload. You can initiate a maximum of nine file
   upload or download tasks at the same time (upload and download tasks count together).
   */
...
enum CANCEL_MEDIA_ERR_CODE {
  ...
  /**
   2: The task to cancel does not exist. You can only cancel an ongoing download or upload task. If
   the download or upload task completes, the corresponding @p requestId is no longer valid.
   */
...
class IRtmChannelAttribute {
 ...
 public:
  ...
  /**
   Release all resources used by the \ref agora::rtm::IRtmChannelAttribute "IRtmChannelAttribute"
   instance.
   */
...
class IMessage {
 ...
 public:
  ...
  /**
   ...
   @param str The text message to be set. Must not exceed 32 KB in length. If the message is a raw
   message, ensure that the overall size of the text description and the raw message data does not
   exceed 32 KB.
   */
  ...
  /**
   ...
   @return The content of the received text message, or the text description of the received raw
   message.
   */
  ...
  /**
   ...
   sent.
   - The returned timestamp is on a millisecond time-scale. It is for demonstration purposes only,
   not for strict ordering of messages.
  ...
  /**
   Allows the receiver to check whether this message has been cached on the server (Applies to
   peer-to-peer message only).

   @note
   - This method returns false if a message is not cached by the server. Only if the sender sends
   the message as an offline message (sets \ref
   agora::rtm::SendMessageOptions::enableOfflineMessaging "enableOfflineMessaging" as true) when the
   specified user is offline, does the method return true when the user is back online.
   - For now we only cache 200 offline messages for up to seven days for each message receiver. When
   the number of the cached messages reaches this limit, the newest message overrides the oldest
   one.

   @return
   - true: This message has been cached on the server (the server caches this message and re-sends
   it to the receiver when he/she is back online).
  ...
  /**
   ...
   @note For the message receiver: please access and save the content of the IMessage instance when
   receiving the \ref agora::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived" or the
   \ref agora::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer "onMessageReceivedFromPeer"
   callback. The SDK will release the IMessage instance when the callback ends.
   */
  virtual void release() = 0;
};
...
class IFileMessage : public IMessage {
 public:
  ...
  /**
   ...
   @param length The length of the thumbnail. The size of @p thumbnail and @p fileName combined must
   not exceed 32 KB.
   */
  ...
  /**
   ...
   @param fileName The name of the uploaded file. The size of @p thumbnail and @p fileName combined
   must not exceed 32 KB.
   */
...
class IImageMessage : public IMessage {
 public:
  ...
  /**
   ...
   @param length The length of the thumbnail in bytes. The size of @p thumbnail and @p fileName
   combined must not exceed 32 KB.
   */
  ...
  /**
   ...
   @param fileName The file name of the uploaded image. The size of @p thumbnail and @p fileName
   combined must not exceed 32 KB.
   */
  virtual void setFileName(const char* fileName) = 0;
  ...
  /**
   ...
   width and height of the image. You can call \ref agora::rtm::IImageMessage::getWidth() "getWidth"
  ...
  /**
   ...
   @note
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK automatically calculates the
   width and height of the image. You can call this method directly to get the width of the image.
   - Image width that is set by calling \ref agora::rtm::IImageMessage::setWidth() "setWidth"
   overrides the width calculated by the SDK.

   @return The width of the uploaded image. Is 0 if the SDK does not support the format of the
   uploaded image.
   */
  ...
  /**
   ...
   @note
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK automatically calculates the
   width and height of the image. You can call \ref agora::rtm::IImageMessage::getHeight()
   "getHeight" directly to get the height of the image.
   - Image height that is set by calling this method overrides the height calculated by the SDK.

   @param height The height of the uploaded image. Is 0 if the SDK does not support the format of
   the uploaded image.
   */
  ...
  /**
   ...
   @note
   - If the uploaded image is in JPG, JPEG, BMP, or PNG format, the SDK automatically calculates the
   width and height of the image. You can call this method directly to get the height of the image.
   - Image height that is set by calling \ref agora::rtm::IImageMessage::setHeight() "setHeight"
  ...
  /**
   ...
   @note You need to work out the width of the thumbnail by yourself, because the SDK does not work
   out the value for you.
  ...
  /**
   ...
   @note You need to work out the height of the thumbnail by yourself, because the SDK does not work
   out the value for you.
...
struct PeerOnlineStatus {
  ...
  /**
   @deprecated Deprecated as of v1.2.0. Use \ref agora::rtm::PeerOnlineStatus::onlineState
   "onlineState" instead.

   The online status of the peer.

   - true: The user is online (the user has logged in the Agora RTM system).
   - false: The user is offline (the user has logged out of the Agora RTM system, has not logged in,
   or has failed to logged in).
   */
  bool isOnline;
  ...
  /**
   ...
   specified peers (\ref agora::rtm::IRtmService::queryPeersOnlineStatus "queryPeersOnlineStatus").
   See also: \ref agora::rtm::IRtmServiceEventHandler::onQueryPeersOnlineStatusResult
   "onQueryPeersOnlineStatusResult".
   - The server may return the `unreachable` state, if you <i>subscribe to</i> the online status of
   specified peers (\ref agora::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus"). See also: \ref
   agora::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged "onPeersOnlineStatusChanged".
   */
...
class IChannelEventHandler {
 public:
  ...
  /**
   ...
   When the local user calls the \ref agora::rtm::IChannel::join "join" method and successfully
   joins the channel:
   - The SDK triggers this callback;
   - All remote users in the channel receive the \ref
   agora::rtm::IChannelEventHandler::onMemberJoined "onMemberJoined" callback.
   */
  ...
  /**
   ...
   The local user receives this callback when the \ref agora::rtm::IChannel::join "join" method call
   fails.

   @param errorCode The error code. See #JOIN_CHANNEL_ERR.
   */
  virtual void onJoinFailure(JOIN_CHANNEL_ERR errorCode) { (JOIN_CHANNEL_ERR) errorCode; }
   ...
   */
  virtual void onLeave(LEAVE_CHANNEL_ERR errorCode) { (LEAVE_CHANNEL_ERR) errorCode; }
  ...
  /**
   ...
   @param userId The message sender.
   @param message The received channel image message. See \ref agora::rtm::IImageMessage
   "IImageMessage".
   */
  ...
  /**
   ...
   @param userId The message sender.
   @param message The received channel file message. See \ref agora::rtm::IFileMessage
   "IFileMessage".
   */
  ...
  /**
   ...
   When a remote user calls the \ref agora::rtm::IChannel::join "join" method and receives the \ref
   agora::rtm::IChannelEventHandler::onJoinSuccess "onJoinSuccess" callback (successfully joins the
   channel), the local user receives this callback.
  ...
  /**
   ...
   When a remote member in the channel calls the \ref agora::rtm::IChannel::leave "leave" method and
   receives the the \ref agora::rtm::IChannelEventHandler::onLeave "onLeave (LEAVE_CHANNEL_ERR_OK)"
  ...
  /**
   ...
   @note This callback is enabled only when the user, who updates the attributes of the channel,
   sets \ref agora::rtm::ChannelAttributeOptions::enableNotificationToChannelMembers
   "enableNotificationToChannelMembers" as true. Also note that this flag is valid only within the
  ...
  /**
   ...
   changes at the frequency of once per second.
   - When the number of channel members exceeds 512, the SDK returns this callback when the number
   changes at the frequency of once every three seconds.
   - You will receive this callback when successfully joining an RTM channel, so Agora recommends
...
class IChannel {
 ...
 public:
  ...
  /**
   ...
   @note You can join a maximum of 20 RTM channels at the same time. When the number of the channels
   you join exceeds the limit, you receive the \ref agora::rtm::JOIN_CHANNEL_ERR
   "JOIN_CHANNEL_ERR_FAILURE" error code.

   - If this method call succeeds:
      - The local user receives the \ref agora::rtm::IChannelEventHandler::onJoinSuccess
   "onJoinSuccess" callback.
      - All remote users receive the \ref agora::rtm::IChannelEventHandler::onMemberJoined
   "onMemberJoined" callback.
   - If this method call fails, the local user receives the \ref
   agora::rtm::IChannelEventHandler::onJoinFailure "onJoinFailure" callback. See #JOIN_CHANNEL_ERR
   for the error codes.
   @return
   - 0: Success.
  ...
  */
  ...
  /**
   ...
   - If this method call succeeds:
      - The local user receives the \ref agora::rtm::IChannelEventHandler::onLeave "onLeave"
   callback with the LEAVE_CHANNEL_ERR_OK state.
      - All remote users receive the \ref agora::rtm::IChannelEventHandler::onMemberLeft
   "onMemberLeft" callback.
   - If this method call fails, the local user receives the \ref
   agora::rtm::IChannelEventHandler::onLeave "onLeave" callback with an error code. See \ref
   agora::rtm::LEAVE_CHANNEL_ERR "LEAVE_CHANNEL_ERR" for the error codes.
   @return
   - 0: Success.
  ...
  /**
   ...
   Agora does not recommend using this method to send a channel message. Use \ref
   agora::rtm::IChannel::sendMessage(const IMessage *message, const SendMessageOptions &options)
   "sendMessage" instead.

   If this method call succeeds:
   - The \ref agora::rtm::IChannelEventHandler::onSendMessageResult "onSendMessageResult" callback
   returns the result.
   - All remote users in the channel receive the \ref
   agora::rtm::IChannelEventHandler::onMessageReceived "onMessageReceived" callback.

   @note You can send messages, including peer-to-peer and channel messages, at a maximum frequency
   of (RTM SDK for Windows C++) 180 calls every three seconds or (RTM SDK for Linux C++) 1500 calls
   every three seconds.
  ...
  /**
   ...
   @param message The message to be sent. See \ref agora::rtm::IMessage "IMessage".
   @param options Options when sending the channel message. See See \ref
  ...
  /**
   ...
   The \ref agora::rtm::IChannelEventHandler::onGetMembers "onGetMembers" callback returns the
   result of this method call.

   @note You can call this method at a maximum frequency of five calls every two seconds. This
   method returns a maximum of 512 members. If the number of channel members exceed 512, the method
   returns 512 members randomly.
...
class IRtmServiceEventHandler {
 public:
  ...
  /**
   ...
   The local user receives this callback when the \ref agora::rtm::IRtmService::login "login" method
   call succeeds.
   */
  ...
  /**
   ...
   The local user receives this callback when the \ref agora::rtm::IRtmService::login "login" method
   call fails. See \ref agora::rtm::LOGIN_ERR_CODE "LOGIN_ERR_CODE" for the error codes.
   */
  ...
  /**
   Occurs when the RTM server detects that the RTM token has exceeded the 24-hour validity period
   and when the SDK is in the \ref agora::rtm::CONNECTION_STATE_RECONNECTING
   "CONNECTION_STATE_RECONNECTING" state.

   - This callback occurs only when the SDK is reconnecting to the server. You will not receive this
   callback when the SDK is in the \ref agora::rtm::CONNECTION_STATE_CONNECTED
   "CONNECTION_STATE_CONNECTED" state.
   - When receiving this callback, generate a new RTM Token on the server and call the \ref
   agora::rtm::IRtmService::renewToken "renewToken" method to pass the new Token on to the server.
   */
  ...
  /**
   ...
   The local user receives this callback when the SDK calls the \ref agora::rtm::IRtmService::logout
   "logout" method. See \ref agora::rtm::LOGOUT_ERR_CODE "LOGOUT_ERR_CODE" for the error codes.
   */
  virtual void onLogout(LOGOUT_ERR_CODE errorCode) { (LOGOUT_ERR_CODE) errorCode; }
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::sendMessageToPeer "sendMessageToPeer"
   method call.
  ...
  /**
   ...
   @param peerId The ID of the message sender.
   @param message The received peer-to-peer image message. See \ref agora::rtm::IImageMessage
   "IImageMessage".
   */
  ...
  /**
   ...
   @param peerId The ID of the message sender.
   @param message The received peer-to-peer file message. See \ref agora::rtm::IFileMessage
   "IFileMessage".
   */
  ...
  /**
   ...
   - If the upload task comes to a halt, the SDK stops returning this callback until the task is
   going again.
   ...
   */
  virtual void onMediaUploadingProgress(long long requestId,
  ...
  /**
   ...
   agora::rtm::MediaOperationProgress "MediaOperationProgress".
   */
  virtual void onMediaDownloadingProgress(long long requestId,
                                          const MediaOperationProgress& progress) {
    (long long)requestId;
    (MediaOperationProgress) progress;
  }
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::createFileMessageByUploading
   ...
   */
  virtual void onFileMediaUploadResult(long long requestId, IFileMessage* fileMessage,
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::createImageMessageByUploading
   ...
   @param code Error codes. See #UPLOAD_MEDIA_ERR_CODE.
   */
  virtual void onImageMediaUploadResult(long long requestId, IImageMessage* imageMessage,
                                        UPLOAD_MEDIA_ERR_CODE code) {
    (long long)requestId;
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::downloadMediaToFile "downloadMediaToFile"
   method call.
  ...
  /**
   ...
   @param code Error codes. See #DOWNLOAD_MEDIA_ERR_CODE.
   */
  virtual void onMediaDownloadToMemoryResult(long long requestId, const char* memory,
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::cancelMediaDownload "cancelMediaDownload"
   or \ref agora::rtm::IRtmService::cancelMediaUpload "cancelMediaUpload" method call.
   ...
   */
  virtual void onQueryPeersOnlineStatusResult(long long requestId,
                                              const PeerOnlineStatus* peersStatus, int peerCount,
  ...
  /**
   Returns the result of the \ref agora::rtm::IRtmService::subscribePeersOnlineStatus
   "subscribePeersOnlineStatus" or \ref agora::rtm::IRtmService::unsubscribePeersOnlineStatus
   "unsubscribePeersOnlineStatus" method call.

   @param requestId The unique ID of this request.
   @param errorCode Error Codes. See #PEER_SUBSCRIPTION_STATUS_ERR.
   */
  virtual void onSubscriptionRequestResult(long long requestId,
  ...
  /**
   Returns the result of the \ref agora::rtm::IRtmService::queryPeersBySubscriptionOption
  ...
  virtual void onQueryPeersBySubscriptionOptionResult(
      long long requestId, const char* peerIds[], int peerCount,
  ...
  /**
   ...
   - When the subscription to the online status of specified peers succeeds, the SDK returns this
   ...
   - If the online status of the peers, to whom you subscribe, changes when the SDK is reconnecting
   to the server, the SDK returns this callback to report whose online status has changed when
   ...
   */
  virtual void onSetLocalUserAttributesResult(long long requestId,
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::addOrUpdateLocalUserAttributes
   "addOrUpdateLocalUserAttributes" method call.

   @param requestId The unique ID of this request.
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onAddOrUpdateLocalUserAttributesResult(long long requestId,
                                                      ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
    (ATTRIBUTE_OPERATION_ERR) errorCode;
  }
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::deleteLocalUserAttributesByKeys
   "deleteLocalUserAttributesByKeys" method call.

   @param requestId The unique ID of this request.
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onDeleteLocalUserAttributesResult(long long requestId,
                                                 ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
    (ATTRIBUTE_OPERATION_ERR) errorCode;
  }
  ...
  /**
   ...
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onClearLocalUserAttributesResult(long long requestId,
                                                ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
    (ATTRIBUTE_OPERATION_ERR) errorCode;
  }
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::getUserAttributes "getUserAttributes" or
   \ref agora::rtm::IRtmService::getUserAttributesByKeys "getUserAttributesByKeys" method call.
   ...
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onGetUserAttributesResult(long long requestId, const char* userId,
                                         const RtmAttribute* attributes, int numberOfAttributes,
                                         ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::addOrUpdateChannelAttributes
  ...
  /**
   Reports the result of the \ref agora::rtm::IRtmService::deleteChannelAttributesByKeys
   "deleteChannelAttributesByKeys" method call.

   @param requestId The unique ID of this request.
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onDeleteChannelAttributesResult(long long requestId,
                                               ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
    (ATTRIBUTE_OPERATION_ERR) errorCode;
  }
  ...
  /**
   ...
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onClearChannelAttributesResult(long long requestId,
                                              ATTRIBUTE_OPERATION_ERR errorCode) {
    (long long)requestId;
    (ATTRIBUTE_OPERATION_ERR) errorCode;
  }
  ...
  /**
   ...
   "getChannelAttributes" or \ref agora::rtm::IRtmService::getChannelAttributesByKeys
   ...
   @param errorCode Error Codes. See #ATTRIBUTE_OPERATION_ERR.
   */
  virtual void onGetChannelAttributesResult(long long requestId,
                                            const IRtmChannelAttribute* attributes[],
                                            int numberOfAttributes,
                                            ATTRIBUTE_OPERATION_ERR errorCode) {
    //         (long long) requestId;
   ...
   */
  virtual void onGetChannelMemberCountResult(long long requestId,
...
class IRtmService {
 ...
 public:
  /**
   ...
   @param appId The App ID issued by Agora to you. Apply for a new App ID from Agora if it is
   missing from your kit.
   @param eventHandler An IRtmServiceEventHandler object that invokes callbacks to be passed to the
   application on Agora RTM SDK runtime events.
   @return
   - 0: Success.
  ...
  /**
   ...
   - If this method call succeeds, the local user receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess" callback.
   - If this method call fails, the local user receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginFailure "onLoginFailure" callback. See \ref
   ...
   - Only after you successfully call this method (when the local user receives the \ref
   agora::rtm::IRtmServiceEventHandler::onLoginSuccess "onLoginSuccess" callback), can you call the
   key RTM methods except:
   ...
   @param token Token used to log in the Agora RTM system and used when dynamic authentication is
   enabled. Set @p token as @p nil in the integration and test stages.
   @param userId The user ID of the user logging in Agora's RTM system. The string must not exceed
   64 bytes in length. It cannot be empty, null or "null". Supported characters:
  ...
  /**
   ...
   The local user receives the \ref agora::rtm::IRtmServiceEventHandler::onLogout "onLogout"
   callback. See \ref agora::rtm::LOGOUT_ERR_CODE "LOGIN_ERR_CODE" for the error codes.
  ...
  /**
   ...
   You are required to renew your RTM Token when receiving the \ref
   agora::rtm::IRtmServiceEventHandler::onTokenExpired "onTokenExpired" callback, and the \ref
   agora::rtm::IRtmServiceEventHandler::onRenewTokenResult "onRenewTokenResult" callback returns the
   result of this method call. The call frequency limit for this method is 2 calls per second.

   @param token Your new RTM Token. You need to generate the RTM Token yourself. See *Generate an
   RTM Token*.
   @return
   - 0: Success.
  ...
  /**
   ...
   @note
   - We do not recommend using this method to send a peer-to-peer message. Use \ref
   agora::rtm::IRtmService::sendMessageToPeer(const char *peerId, const IMessage *message, const
   SendMessageOptions &options) "sendMessageToPeer" instead.
   - You can send messages, including peer-to-peer and channel messages, at a maximum frequency of
   (RTM SDK for Windows C++) 180 calls every three seconds or (RTM SDK for Linux C++) 1500 calls
   every three seconds.

   @param peerId User ID of the receiver.
   @param message The message to be sent. For information about creating a message, see \ref
  ...
  /**
   ...
   The SDK returns the result of this method call by the \ref
   agora::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult "onMediaDownloadToMemoryResult"
   callback.

   @note
   - This method applies to scenarios requiring quick access to the downloaded file or image.
   - The SDK releases the downloaded file or image immediately after returning the \ref
   agora::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult "onMediaDownloadToMemoryResult"
   callback.
  ...
  /**
   ...
   The SDK returns the result of this method call by the \ref
   agora::rtm::IRtmServiceEventHandler::onMediaDownloadToFileResult "onMediaDownloadToFileResult"
   callback.
   ...
   - &ne;0: Failure. See #DOWNLOAD_MEDIA_ERR_CODE for the error codes.
   */
  virtual int downloadMediaToFile(const char* mediaId, const char* filePath,
                                  long long& requestId) = 0;

  /**
   Cancels an ongoing file or image download task by request ID.

   The SDK returns the result of this method call with the \ref
   agora::rtm::IRtmServiceEventHandler::onMediaCancelResult "onMediaCancelResult" callback.
  ...
  /**
   ...
   This method allows you to send a message to a specified user when he/she is offline. If you set a
   ...
   AGORA_RTM_ENDCALL_PREFIX_\<channelId\>_\<your additional information\>, then this method is
   compatible with the endCall method of the legacy Agora Signaling SDK. Replace \<channelId\> with
   the channel ID from which you want to leave (end call), and replace \<your additional
   information\> with any additional information. Note that you must not put any "_" (underscore" in
   your additional information but you can set \<your additional information\> as empty "".

   - The \ref agora::rtm::IRtmServiceEventHandler::onSendMessageResult "onSendMessageResult"
   callback returns the result of this method call.
   - When the message arrives at the receiver, the receiver receives the \ref
   agora::rtm::IRtmServiceEventHandler::onMessageReceivedFromPeer "onMessageReceivedFromPeer"
   callback.
   ...
   @param peerId User ID of the receiver. The string must not exceed 64 bytes in length. It cannot
   be empty, null, or "null". Supported characters:
   ...
   @param message The message to be sent. For information about creating a message, See \ref
   agora::rtm::IMessage "IMessage".
   @param options Options when sending the message to a peer. See \ref
   agora::rtm::SendMessageOptions "SendMessageOptions".
   @return
   - 0: Success.
   - &ne;0: Failure. See #PEER_MESSAGE_ERR_CODE for the error codes.
   */
  virtual int sendMessageToPeer(const char* peerId, const IMessage* message,
  ...
  /**
   ...
   @note You can create multiple channels in an IRtmService instance. But you can only join a
   maximum of 20 channels at the same time. As a good practice, Agora recommends calling the \ref
   agora::rtm::IChannel::release "release" method to release all resources of an RTM channel that
   you no longer use.

   @param channelId The unique channel name. A @p channelId cannot be empty, null, or "null". Must
   be less than 64 bytes in length. Supported characters:
   - All lowercase English letters: a to z
   - All uppercase English letters: A to Z
   - All numeric characters: 0 to 9
   - The space character.
   ...
   @return
   - An \ref agora::rtm::IChannel "IChannel" object: Success. If a channel with the same @p
   channelId does not exist, the method returns the created channel instance. If a channel with the
   same @p channelId already exists, the method returns the existing channel instance.
   - null: Failure. Possible reasons: The @p channelId is invalid or you have joined the maximum
   number of channels.
   */
  ...
  /**
   ...
   Each \ref agora::rtm::IRtmService "IRtmService" object corresponds to a unique \ref
   agora::rtm::IRtmCallManager "IRtmCallManager" object. That said, the \ref
   agora::rtm::IRtmCallManager "IRtmCallManager" object is \ref agora::rtm::IRtmService
   "IRtmService"-specific.

   @note When you do no use \ref agora::rtm::IRtmCallManager "IRtmCallManager", call the \ref
   agora::rtm::IRtmCallManager::release "release" method to release all of its resources.
  ...
  /**
   ...
   @note
   - An \ref agora::rtm::IMessage "IMessage" instance can be used either for a channel message or
   for a peer-to-peer message.
   - When you no longer need an \ref agora::rtm::IMessage "IMessage" instance, please call the \ref
   agora::rtm::IMessage::release "release" method to release all resources that it is using.
   - You can set the content of the text message at a later point using the \ref
   agora::rtm::IMessage::setText "setText" method, but please ensure that the size of the text
   message does not exceed 32 KB.
  ...
  /**
   ...
   - When you no longer need an \ref agora::rtm::IMessage "IMessage" instance, please call the \ref
   agora::rtm::IMessage::release "release" method to release all resources that it is using.
   - You can set a brief text description of the raw message at a later point using the \ref
   agora::rtm::IMessage::setText "setText" method, but please ensure that the size of the raw
   message and the description combined does not exceed 32 KB.
  ...
  /**
   ...
   - When you no longer need an \ref agora::rtm::IMessage "IMessage" instance, please call the \ref
   agora::rtm::IMessage::release "release" method to release all resources that it is using.
   - You can set @p description as "" and add a brief text description of the raw message at a later
   point using the \ref agora::rtm::IMessage::setText "setText" method, but please ensure that the
   size of the raw message and the description combined does not exceed 32 KB.
  ...
  /**
   ...
   - If you have at hand the media ID of a file on the Agora server, you can call this method to
   create an \ref agora::rtm::IFileMessage "IFileMessage" instance.
   - If you do not have a media ID, then you must call \ref
   agora::rtm::IRtmService::createFileMessageByUploading "createFileMessageByUploading" to get a
   corresponding \ref agora::rtm::IFileMessage "IFileMessage" instance by uploading a file to the
   Agora RTM server.
  ...
  /**
   ...
   - If you have at hand the media ID of an image on the Agora server, you can call this method to
   create an \ref agora::rtm::IImageMessage "IImageMessage" instance.
   - If you do not have a media ID, then you must call \ref
   agora::rtm::IRtmService::createImageMessageByUploading "createImageMessageByUploading" to get a
   corresponding \ref agora::rtm::IImageMessage "IImageMessage" instance by uploading an image to
   the Agora RTM server.
  ...
  /**
   Gets an \ref agora::rtm::IFileMessage "IFileMessage" instance by uploading a file to the Agora
   server.

   The SDK returns the result with the \ref
   agora::rtm::IRtmServiceEventHandler::onFileMediaUploadResult callback. If success, this callback
   returns a corresponding \ref agora::rtm::IFileMessage "IFileMessage" instance.

   @note
   - If you have at hand the media ID of a file on the Agora server, you can call \ref
   agora::rtm::IRtmService::createFileMessageByMediaId "createFileMessageByMediaId" to create an
   \ref agora::rtm::IFileMessage "IFileMessage" instance.
   - To cancel an ongoing file upload task, call \ref agora::rtm::IRtmService::cancelMediaUpload
   "cancelMediaUpload".
  ...
  /**
   Gets an \ref agora::rtm::IImageMessage "IImageMessage" instance by uploading an image to the
   Agora server.

   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onImageMediaUploadResult callback. If success, this callback
   returns a corresponding \ref agora::rtm::IImageMessage "ImageMessage" instance.

   - If the uploaded image is in JPEG, JPG, BMP, or PNG format, the SDK calculates the width and
   height of the image. You can call \ref agora::rtm::IImageMessage::getWidth "getWidth" and \ref
   agora::rtm::IImageMessage::getHeight "getHeight" to get the calculated width and height.
   - Otherwise, you need to call \ref agora::rtm::IImageMessage::setWidth "setWidth" and \ref
   agora::rtm::IImageMessage::setHeight "setHeight" to set the width and height of the uploaded
   image by yourself.

   @note
   - If you have at hand the media ID of an image on the Agora server, you can call \ref
   agora::rtm::IRtmService::createImageMessageByMediaId "createImageMessageByMediaId" to create an
   \ref agora::rtm::IImageMessage "IImageMessage" instance.
   - To cancel an ongoing image upload task, call \ref agora::rtm::IRtmService::cancelMediaUpload
   "cancelMediaUpload".
  ...
  /**
   ...
   @note The JSON options are not public by default. Agora is working on making commonly used JSON
   options public in a standard way. Contact [support@agora.io](mailto:support@agora.io) for more
   information.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onQueryPeersOnlineStatusResult
   "onQueryPeersOnlineStatusResult" callback.
   ...
   */
  virtual int queryPeersOnlineStatus(const char* peerIds[], int peerCount,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onSubscriptionRequestResult "onSubscriptionRequestResult"
   callback.

   - When the method call succeeds, the SDK returns the \ref
   agora::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged "onPeersOnlineStatusChanged"
   callback to report the online status of peers, to whom you subscribe.
   - When the online status of the peers, to whom you subscribe, changes, the SDK returns the \ref
   agora::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged "onPeersOnlineStatusChanged"
   callback to report whose online status has changed.
   - If the online status of the peers, to whom you subscribe, changes when the SDK is reconnecting
   to the server, the SDK returns the \ref
   agora::rtm::IRtmServiceEventHandler::onPeersOnlineStatusChanged "onPeersOnlineStatusChanged"
   callback to report whose online status has changed when successfully reconnecting to the server.

   @note
   - When you log out of the Agora RTM system, all the status that you subscribe to will be cleared.
   To keep the original subscription after you re-log in the system, you need to redo the whole
   ...
   */
  virtual int subscribePeersOnlineStatus(const char* peerIds[], int peerCount,
                                         long long& requestId) = 0;
  ...
  /**
   ...
   - &ne;0: Failure. See #PEER_SUBSCRIPTION_STATUS_ERR for the error codes.
   */
  virtual int unsubscribePeersOnlineStatus(const char* peerIds[], int peerCount,
                                           long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onQueryPeersBySubscriptionOptionResult
   "onQueryPeersBySubscriptionOptionResult" callback.
   ...
   */
  virtual int queryPeersBySubscriptionOption(PEER_SUBSCRIPTION_OPTION option,
                                             long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onSetLocalUserAttributesResult
   "onSetLocalUserAttributesResult" callback.

   @note For \ref agora::rtm::IRtmService::setLocalUserAttributes "setLocalUserAttributes", \ref
   agora::rtm::IRtmService::addOrUpdateLocalUserAttributes "addOrUpdateLocalUserAttributes", \ref
   agora::rtm::IRtmService::deleteLocalUserAttributesByKeys "deleteLocalUserAttributesByKeys" and
   \ref agora::rtm::IRtmService::clearLocalUserAttributes "clearLocalUserAttributes" taken together:
   the maximum call frequency is (RTM SDK for Windows C++) 10 calls every five seconds or (RTM SDK
   ...
   */
  virtual int setLocalUserAttributes(const RtmAttribute* attributes, int numberOfAttributes,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onAddOrUpdateLocalUserAttributesResult
   "onAddOrUpdateLocalUserAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int addOrUpdateLocalUserAttributes(const RtmAttribute* attributes, int numberOfAttributes,
                                             long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onDeleteLocalUserAttributesResult
   "onDeleteLocalUserAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int deleteLocalUserAttributesByKeys(const char* attributeKeys[], int numberOfKeys,
                                              long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onClearLocalUserAttributesResult
   "onClearLocalUserAttributesResult" callback.
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onGetUserAttributesResult "onGetUserAttributesResult"
   callback.

   @note For \ref agora::rtm::IRtmService::getUserAttributes "getUserAttributes" and \ref
   agora::rtm::IRtmService::getUserAttributesByKeys "getUserAttributesByKeys" taken together, the
   maximum call frequency is (RTM SDK for Windows C++) 40 calls every five seconds or (RTM SDK for
   Linux C++) 400 calls every five seconds.
  ...
  /**
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int getUserAttributesByKeys(const char* userId, const char* attributeKeys[],
                                      int numberOfKeys, long long& requestId) = 0;

  /**
   Resets the attributes of a specified channel.

   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onSetChannelAttributesResult "onSetChannelAttributesResult"
   callback.
   ...
   couple of minutes.
   - If more than one user can update the channel attributes, then Agora recommends calling \ref
   agora::rtm::IRtmService::getChannelAttributes "getChannelAttributes" to update the cache before
   calling this method.
   - For \ref agora::rtm::IRtmService::setChannelAttributes "setChannelAttributes", \ref
   agora::rtm::IRtmService::addOrUpdateChannelAttributes "addOrUpdateChannelAttributes", \ref
   agora::rtm::IRtmService::deleteChannelAttributesByKeys "deleteChannelAttributesByKeys" and \ref
   ...
   @param attributes An array of channel attributes. See \ref agora::rtm::IRtmChannelAttribute
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int setChannelAttributes(const char* channelId, const IRtmChannelAttribute* attributes[],
                                   int numberOfAttributes, const ChannelAttributeOptions& options,
                                   long long& requestId) = 0;

  /**
   Adds or updates the attribute(s) of a specified channel.

   This method updates the specified channel's attribute(s) if it finds that the attribute(s)
   has/have the same key(s), or adds attribute(s) to the channel if it does not.

   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onAddOrUpdateChannelAttributesResult
   "onAddOrUpdateChannelAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int addOrUpdateChannelAttributes(const char* channelId,
                                           const IRtmChannelAttribute* attributes[],
                                           int numberOfAttributes,
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onDeleteChannelAttributesResult
   "onDeleteChannelAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int deleteChannelAttributesByKeys(const char* channelId, const char* attributeKeys[],
                                            int numberOfKeys,
                                            const ChannelAttributeOptions& options,
                                            long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onClearChannelAttributesResult
   "onClearChannelAttributesResult" callback.
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int clearChannelAttributes(const char* channelId, const ChannelAttributeOptions& options,
                                     long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onGetChannelAttributesResult "onGetChannelAttributesResult"
   callback.
  ...
  /**
   ...
   - &ne;0: Failure. See #ATTRIBUTE_OPERATION_ERR for the error codes.
   */
  virtual int getChannelAttributesByKeys(const char* channelId, const char* attributeKeys[],
                                         int numberOfKeys, long long& requestId) = 0;
  ...
  /**
   ...
   The SDK returns the result by the \ref
   agora::rtm::IRtmServiceEventHandler::onGetChannelMemberCountResult
   "onGetChannelMemberCountResult" callback.
   ...
   */
  virtual int getChannelMemberCount(const char* channelIds[], int channelCount,
                                    long long& requestId) = 0;
  ...
  /**
   ...
   - Ensure that you call this method immediately after calling the \ref
   agora::rtm::IRtmService::initialize "initialize" method to initialize an \ref
   agora::rtm::IRtmService "IRtmService" instance, otherwise the output log may be incomplete.
  ...
  /**
   ...
   @param fileSizeInKBytes The size of a single log file (KB). For RTM C++ SDK for Windows, the
   default is `10240` (KB). For RTM C++ SDK for Linux,  the default is `102400` (KB). The value
   range is [512 KB, 1 GB].
   @return
   - 0: Success.
   - &ne;0: Failure.
   */
...
@note When you no longer need an \ref agora::rtm::IRtmService "IRtmService" instance, ensure that
you call the \ref agora::rtm::IRtmService::release "release" method to release all resources that it
uses.
...
/**
 Region for the Agora RTM service. After setting a region, the RTM SDK can only connect to the Agora
 RTM service in the specified region.
 */
enum RTM_AREA_CODE {
  /**
   * Mainland China.
...
/**
 Error codes returned by \ref agora::rtm::setRtmServiceContext "setRtmServiceContext". See
 #RTM_AREA_CODE.
 */
enum SET_RTM_SERVICE_CONTEXT_ERR_CODE {
  ...
  /**
   1: Failed to configure the context for the Agora RTM service because at least one \ref
   agora::rtm::IRtmService "IRtmService" instance already exists. Call \ref
   agora::rtm::IRtmService::release "release" to destroy any existing `%IRtmService` instance before
   configuring the context for the Agora RTM service.
   */
  SET_RTM_SERVICE_CONTEXT_ERR_FAILURE = 1,
};

/**
 Sets the context of all `IRtmService` instances. All `%IRtmservice` instances you create after
 calling this method match the context.

 @note You must call this method before calling #createRtmService to create an `%IRtmservice`
 instance or after destroying any existing `%IRtmservice` instance. Otherwise, this method returns
 the #SET_RTM_SERVICE_CONTEXT_ERR_FAILURE error code.

 @param context Context of the `%IRtmservice` instance, including geofencing and cloud proxy. See
 \ref agora::rtm::RtmServiceContext "RtmServiceContext".

 @return #SET_RTM_SERVICE_CONTEXT_ERR_CODE.
 */
AGORA_API SET_RTM_SERVICE_CONTEXT_ERR_CODE AGORA_CALL
setRtmServiceContext(const RtmServiceContext& context);
