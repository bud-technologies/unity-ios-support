...
/** Joins the channel with a user ID.
 ...
 This method differs from the [joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:])1 method in the AgoraRtcEngineKit class in the following aspects:

| [AgoraRtcChannel joinChannelByToken]([AgoraRtcChannel joinChannelByToken:info:uid:options:])                                                  | [AgoraRtcEngineKit joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:uid:joinSuccess:])1                                                                                       |
|------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------|
...
| Contains the `options` parameter, which decides whether to subscribe to all streams before joining the channel.                                  | Does not contain the `options` parameter. By default, users subscribe to all streams when joining the channel. To configure media subscribing options when joining the channel, use [joinChannelByToken]([AgoraRtcEngineKit joinChannelByToken:channelId:info:uid:options:])2 instead. |
 ...
 **Note**
 ...
 the following:
  ...
  call [muteRemoteAudioStream(false)]([AgoraRtcChannel muteRemoteAudioStream:mute:]), and specify the user ID.
 ...
 **Note**
 ...
 the following:
  ...
  call [muteRemoteVideoStream(false)]([AgoraRtcChannel muteRemoteVideoStream:mute:]), and specify the user ID.
