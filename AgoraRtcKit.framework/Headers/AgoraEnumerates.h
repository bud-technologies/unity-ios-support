...
typedef NS_ENUM(NSInteger, AgoraUploadErrorReason) {
  /** The log file is successfully uploaded.
   */
  AgoraUploadErrorReasonSuccess = 0,
  /** Network error. Check the network connection and call [uploadLogFile]([AgoraRtcEngineKit uploadLogFile])
   * again to upload the log file.
   */
  AgoraUploadErrorReasonNetError = 1,
  /** An error occurs in the Agora server. Try uploading the log files later.
   */
